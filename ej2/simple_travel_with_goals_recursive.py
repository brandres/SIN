...
Recursive version with multiple goal
"""
...
def travel_recursive(state, goal):
    if len(goal.loc) > 0:
        # solo nos interesa el primer goal pero como es un diccionario y
        # no permite indexado (en python v3.6, aunque versiones anteriores si)
        # hemos de hacerlo asi
...
pyhop.declare_methods('travel', travel_recursive)
print('')
pyhop.print_methods()
